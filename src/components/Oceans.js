...
const styles = StyleSheet.create({
  pressed: {
    borderWidth: 1, borderRadius: 10, borderColor: '#666699', height: hp('6%'), width: wp('26%'), justifyContent: 'center', backgroundColor: '#005c99', margin: 10
  },
  unPressed: {
    borderWidth: 1, borderRadius: 10, borderColor: '#666699', height: hp('6%'), width: wp('26%'), justifyContent: 'center', backgroundColor: '#33adff', margin: 10
  }
});
